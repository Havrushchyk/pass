...
# create model
model = Sequential()
model.add(Dense(128, input_dim=X.shape[1], activation='relu')) # 274
model.add(Dense(128, activation='relu')) # relu 548
model.add(Dense(1, activation='sigmoid'))  # softmax sigmoid

# Compile model
model.compile(loss='binary_crossentropy', optimizer='adam', metrics=['accuracy'])
# Fit the model
model.fit(X, y, epochs=50000, batch_size=81,callbacks=[early_stopping])
